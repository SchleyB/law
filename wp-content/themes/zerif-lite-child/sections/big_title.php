<?php
		...
		echo '<div class="row">';
			echo '<div class="col-sm-6">';
				echo '<div class="main-header-box">';
					...
					echo '<a href="tel:512-407-9700"><button id="header-button"><strong>FREE</strong> Consultation Now</button></a>';
				echo '</div>';
		echo '</div>';
	...
	echo '</div><!-- .header-content-wrap -->';
		...
		echo '<div id="orange-bar"><img src="/wp-content/uploads/2015/09/dorbandt-portrait1.jpg"><p><a href="tel:512-407-9700">Call 512.407.9700</a></p></div>';
