...
<script>
	...
	jQuery(function(){
		var margn = parseInt(jQuery("#test_col").css('margin-left'));
		var begn = /^(33).*$/;
		var endn = /^[-](366).*$/;
...
<header id="home" class="header">
	...
	<div class="row bannr">
		<p>Free Initial Consultation - <a href="tel:512-407-9700"><b><font color="4B8EC9">Call 512.407.9700</font></b></a></p>
	</div>	
		<div class="container">
